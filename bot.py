...
from google.genai.client import configure  # <--- CRITICAL FIX: Only configure imported from client
...
try:
    ...
    try:
        # Use the GenerativeModel class imported directly from the top level (via genai)
